...
public:
	...
	/// If you are connecting to another system, you can call this with values for the (e and p,ru.edgar.space.core.ui.keyboard.q) public keys before connecting to prevent MitM
