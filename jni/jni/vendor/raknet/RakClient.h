...
public:
	...
	/// \ingroup RAKNET_RPC
	/// a C or static member function as available for calling as a remote procedure call
	...
	/// \ingroup RAKNET_RPC
	/// a C++ member function as available for calling as a remote procedure call.
