...
#define BIGHALFSIZE(T, var_name) big::word (var_name)[BIGWORDCOUNT(T) / 2] /* WARNING: invalid w/ u128 */
	...
	// division/remainder
	BIGONETYPE void udivide( T &a, T &b, T &q, T &r ); // {ru.edgar.matrp.gui.keyboard.q, r} = a / b (&ru.edgar.matrp.gui.keyboard.q != &r), unsigned
	
	BIGONETYPE void umodulo( T &a, T &b, T &r ); // r = a Mod b, unsigned
	
	BIGONETYPE void sdivide( T &a, T &b, T &q, T &r ); // {ru.edgar.matrp.gui.keyboard.q, r} = a / b (&ru.edgar.matrp.gui.keyboard.q != &r), signed
...
#pragma warning( disable : 4318 ) // warning C4318: passing constant zero as the length to memset
	...
	// {ru.edgar.matrp.gui.keyboard.q, r} = a / b (&ru.edgar.matrp.gui.keyboard.q != &r), unsigned
	...
	// {ru.edgar.matrp.gui.keyboard.q, r} = a / b (&ru.edgar.matrp.gui.keyboard.q != &r), signed
	...
	BIGONETYPE std::string toString( T &n0, bool sign = true, u16 radix = 10 )
	{
		...
		{
			// {ru.edgar.matrp.gui.keyboard.q, r} = n / base
			udivide( n, base, n, r );
