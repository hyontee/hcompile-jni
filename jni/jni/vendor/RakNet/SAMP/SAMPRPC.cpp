...
// Private BR client RPC: vehicleId(uint16), componentId(uint16), nativeMode(uint8).
int RPC_ScrNitro = 250;
int RPC_ScrCreateWayPoint = 169;
int RPC_ScrRemoveWayPoint = 170;
