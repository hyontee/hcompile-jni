...
void* hack_thread(void* args)
{
	...
	void* addDebugMessageAddr = (void *)(CGameAPI::GetBase(xorstr("CChat::AddDebugMessage")));
	if(addDebugMessageAddr) {
		DobbyHook(addDebugMessageAddr, (void *)&hook_CChat__AddDebugMessage, (void **)&orig_CChat__AddDebugMessage);
	}
