...
void* hack_thread(void* args)
{
    ...
    uintptr_t rwInitialised = CGameAPI::GetBase(xorstr("RwInitialised"));
    while(rwInitialised && *(int *)(rwInitialised) == 0) {
        usleep(1000);
    }
    if (!rwInitialised) {
        return nullptr;
	...
	DobbyHook((void *)(CGameAPI::GetBase(xorstr("BRClient::ProcessChatCommand"))), (void *)&hook_BRClient__ProcessChatCommand, (void **)&orig_BRClient__ProcessChatCommand);
