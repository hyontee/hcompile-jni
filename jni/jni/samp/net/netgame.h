...
#define RPC_FUELSTATION_BUY 380
...
#define RPC_BB_SHOW_TABLET      100
#define RPC_BB_PLACE            101
#define RPC_BB_PLAY             102
#define RPC_BB_STOP             103
#define RPC_BB_PICKUP           104
// server -> client
#define RPC_SV_BB_PLAY_AT_POS   110
#define RPC_SV_BB_STOP          111
#define RPC_PASSPORT 74
#define RPC_MVD_ID 80
// Packet 253
#define RPC_TOGGLE_CHOOSE_SPAWN (2)
#define RPC_BADGES_QUERY   201
#define RPC_BADGES_ANSWER  202
#define RPC_STATISTIC_USER  205
#define RPC_TOGGLE_SPECIALS     2001
#define RPC_FAMILY_MENU     206
#define RPC_FAMILY_ACTION_MENU 207
...
public:
    ...
    CStreamPool* GetStreamPool() const { return m_pStreamPool; }
    static void packetPassport(Packet* p);
    static void packetBADGES_ANSWER(Packet* p);
