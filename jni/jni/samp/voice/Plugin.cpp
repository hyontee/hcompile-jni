...
// позиция: сильно выше и левее
        ImVec2 pos2 = ImVec2(screenWidth * 0.05f, screenHeight * 0.35f);

// размер: 8% от ширины (чуть меньше стандартного)
        ImVec2 size2 = ImVec2(screenWidth * 0.08f, screenWidth * 0.08f);
        ...
        if (!Plugin::muteStatus) {
            ...
            ImGui::ImageButton((ImTextureID)MicroIcon::tMutedIcon->raster, size2);
        }
