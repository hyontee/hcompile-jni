...
//switch weapons
extern "C" {
	JNIEXPORT void JNICALL Java_com_nvidia_devtech_NvEventQueueActivity_openSettings(JNIEnv *pEnv, jobject thiz) { // настройки чота
		pNetGame->SendChatCommand("/mm");
	}
}
extern "C" {
	JNIEXPORT void JNICALL Java_com_nvidia_devtech_NvEventQueueActivity_openStatistik(JNIEnv *pEnv, jobject thiz) { // статистика чота
		pNetGame->SendChatCommand("/mm");
	}
}
extern "C" {
	JNIEXPORT void JNICALL Java_com_nvidia_devtech_NvEventQueueActivity_openInv(JNIEnv *pEnv, jobject thiz) { // инвентарь чота
		pNetGame->SendChatCommand("/inv");
	}
}
extern "C" {
	JNIEXPORT void JNICALL Java_com_nvidia_devtech_NvEventQueueActivity_openDonate(JNIEnv *pEnv, jobject thiz) { // донат чота
		pNetGame->SendChatCommand("/donate");
	}
}
extern "C" {
	JNIEXPORT void JNICALL Java_com_nvidia_devtech_NvEventQueueActivity_openAnim(JNIEnv *pEnv, jobject thiz) { // аним чота
		pNetGame->SendChatCommand("/anim");
	}
}
extern "C" {
	JNIEXPORT void JNICALL Java_com_nvidia_devtech_NvEventQueueActivity_openReport(JNIEnv *pEnv, jobject thiz) { // репорт чота
		pNetGame->SendChatCommand("/rep");
	}
}
extern "C" {
	JNIEXPORT void JNICALL Java_com_nvidia_devtech_NvEventQueueActivity_openFamily(JNIEnv *pEnv, jobject thiz) { // семья чота
		pNetGame->SendChatCommand("/family");
	}
}
extern "C" {
	JNIEXPORT void JNICALL Java_com_nvidia_devtech_NvEventQueueActivity_openNavigator(JNIEnv *pEnv, jobject thiz) { // навигатор чота
		pNetGame->SendChatCommand("/gps");
	}
}
extern "C" {
	JNIEXPORT void JNICALL Java_com_nvidia_devtech_NvEventQueueActivity_openCar(JNIEnv *pEnv, jobject thiz) { // машина чота
		pNetGame->SendChatCommand("/car");
	}
}
extern "C" {
	JNIEXPORT void JNICALL Java_com_nvidia_devtech_NvEventQueueActivity_openPromo(JNIEnv *pEnv, jobject thiz) { // промокод чота
		pNetGame->SendChatCommand("/promo");
	}
}
extern "C" {
	JNIEXPORT void JNICALL Java_com_nvidia_devtech_NvEventQueueActivity_openMenu(JNIEnv *pEnv, jobject thiz) { // открытие меню
		g_pJavaWrapper->ShowMenu(1);
	}
}
extern "C" {
	JNIEXPORT void JNICALL Java_com_nvidia_devtech_NvEventQueueActivity_openMagazine(JNIEnv *pEnv, jobject thiz) {
		pNetGame->SendChatCommand("/donate");
	}
}
extern "C" {
