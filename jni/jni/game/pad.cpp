...
extern "C" {
	JNIEXPORT void JNICALL Java_com_nvidia_devtech_NvEventQueueActivity_showG(JNIEnv *pEnv, jobject thiz)  // сесть на пассажирское(G)
	{
...
extern "C" {
	JNIEXPORT void JNICALL Java_com_nvidia_devtech_NvEventQueueActivity_showY(JNIEnv *pEnv, jobject thiz)  // Y
	{
...
extern "C" {
	JNIEXPORT void JNICALL Java_com_nvidia_devtech_NvEventQueueActivity_showN(JNIEnv *pEnv, jobject thiz)  // N
	{
...
extern "C" {
	JNIEXPORT void JNICALL Java_com_nvidia_devtech_NvEventQueueActivity_showFlip(JNIEnv *pEnv, jobject thiz) // двигатель
	{
		pNetGame->SendChatCommand("/flip");
	}
}

extern "C" {
	JNIEXPORT void JNICALL Java_com_nvidia_devtech_NvEventQueueActivity_spawnCls63(JNIEnv *pEnv, jobject thiz) // двигатель
	{
		pNetGame->SendChatCommand("/veh 415 0 0");
	}
}

extern "C" {
	JNIEXPORT void JNICALL Java_com_nvidia_devtech_NvEventQueueActivity_spawnF10(JNIEnv *pEnv, jobject thiz) // двигатель
	{
		pNetGame->SendChatCommand("/veh 576 0 0");
	}
}

extern "C" {
	JNIEXPORT void JNICALL Java_com_nvidia_devtech_NvEventQueueActivity_closeCarjava(JNIEnv *pEnv, jobject thiz) // двигатель
	{
		g_pJavaWrapper->HideRpc();
	}
}

extern "C" {
	JNIEXPORT void JNICALL Java_com_nvidia_devtech_NvEventQueueActivity_engine(JNIEnv *pEnv, jobject thiz) // двигатель
	{
