...
public:
    ...
    void CreatePlate(ePlateType eType, char *szNumber, char *szRegion);
...
public:
	...
	uint8_t			m_bLightState;

	uint8_t			m_byteColor1;
	uint8_t			m_byteColor2;
	bool 			m_bColorChanged;

	CRGBA 			mVehicleColor {0, 0, 0, 255};
	CRGBA 			mVehicleColorSecond {0, 0, 0, 255};

	RwTexture* pNumberPlateTexture = nullptr;
	...
	bool 	bIsOnRightPovorotnik = false;
	bool 	bIsOnLeftPovorotnik = false;
	bool 	bIsOnAvariyka = false;
