...
public:
	...
	CObject* NewObject(int iModel, float fPosX, float fPosY, float fPosZ, CVector vecRot, float fDrawDistance);
	...
	// 0.3.7
	void SetCheckpoint(CVector* pos, CVector* extent);
