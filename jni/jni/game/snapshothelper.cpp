...
//256, 256
	uintptr_t raster = (uintptr_t)RwRasterCreate(512, 512, 64, rwRASTERFORMAT8888 | rwRASTERTYPECAMERATEXTURE);
	// RwTextureCreate
	uintptr_t bufferTexture = ((uintptr_t(*)(uintptr_t))(g_libGTASA + 0x1B1B4C + 1))(raster);
	...
	*(uintptr_t*)(m_camera + 0x60) = raster;
	...
	//0Log("[CGameRender] rwTexture->raster->cpPixels = %d", rwTexture->raster->cpPixels);
