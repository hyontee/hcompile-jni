  ...
  if ( (a1 & 0x10000) == 0 )
  {
    ...
    if ( v2 )
    {
      ...
      if ( (a1 & 0x40) == 0 )
        goto LABEL_45;
LABEL_44:
      snprintf(s, 0x200u, "fcolor.xyz = mix(fcolor.xyz, texture2D(EnvMap, Out_Tex1).xyz, EnvMapCoefficient * 1.24);");
      strcat(byte_617290, s);
...
LABEL_42:
  ...
  snprintf(s, 0x200u, "fcolor *= vec4(Out_Color.xyz * waterDetail * 1.22, Out_Color.w);");
  strcat(byte_617290, s);
...
LABEL_45:
  if ( (a1 & 0x1000000) != 0 )
  {
    ...
    snprintf(s, 0x200u, "float newEnvMapCoef = EnvMapCoefficient + 0.22;");
    strcat(byte_617290, s);
    
    snprintf(s, 0x200u, "fcolor.xyz = mix(fcolor.xyz, ReflTexture.xyz, newEnvMapCoef);");
    strcat(byte_617290, s);
    
    snprintf(s, 0x200u, "fcolor.w += ReflTexture.b * 0.20;");
    strcat(byte_617290, s);
  ...
  if ( (a1 & 0x4000000) != 0 )
  {
    snprintf(s, 0x200u, "fcolor.xyz += fcolor.xyz * 0.78;");
    strcat(byte_617290, s);
