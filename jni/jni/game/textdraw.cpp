...
void CTextDraw::Draw()
{
    ...
    {
        if(m_TextDrawData.dwStyle == 4 || m_TextDrawData.dwStyle == 5)
            DrawTextured();
        else DrawDefault();
    }
    else DrawTextured();
...
void CTextDraw::DrawTextured()
{
	...
	if (m_bHovered) {
		DrawTextureUV(TextDrawTextures, &rect, m_dwHoverColor,
					  m_TextDrawData.dwStyle == 5 ? uv_reflected : uv_normal);
	}
	else {
		DrawTextureUV(TextDrawTextures, &rect, m_TextDrawData.dwLetterColor,
					  m_TextDrawData.dwStyle == 5 ? uv_reflected : uv_normal);
	}
}
