...
struct SCustomPlate
{
    ...
    const char* GetNumber() const { return szNumber; }
    const char* GetRegion() const { return szRegion; }
};
...
public:
    ...
    static const char* GetNumberByVehicleId(uint16_t vehicleId);
    static const char* GetRegionByVehicleId(uint16_t vehicleId);

    static std::string nomer;
