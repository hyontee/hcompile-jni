...
void readVehiclesAudioSettings() 
{
	...
	char buffer[0xFF];
	sprintf(buffer, "%sSPACE/vehicleAudioSettings.cfg", g_pszStorage);
...
void ApplyPatches()
{
    ...
    *(uint8_t*)(g_libGTASA + 0x4EE200) = 0x9B;
      ...
      // --------------------------------------------------------------------------------------------------------------------------------------------------------------------------
      // new patches 10.06.23 *by Weikton :D
	...
	CHook::WriteMemory(g_libGTASA + 0x001A7EB0, "\x4F\xF4\x00\x10\x4F\xF4\x80\x06", 8); 	// RenderQueue::RenderQueue
...
void ApplyInGamePatches()
{
	...
	Log(OBFUSCATE("Installing patches (ingame).."));
                  // -----------------------------------------------------------------------------------
                  // ����� ������ �����
	// WriteMemory(g_libGTASA + 0x5B9D30, (uintptr_t)"TEXDB", 2);
                  // -----------------------------------------------------------------------------------
