...
bool (*orig_RakClient__Connect)(uintptr_t thiz, const char* host, uint16_t server, uint16_t client, unsigned int depreciated, int threadSleepTimer);
bool hook_RakClient__Connect(uintptr_t thiz, const char* host, uint16_t serverPort, uint16_t clientPort, unsigned int depreciated, int threadSleepTimer)
{
    ...
    return pRakClient->Connect(188.127.241.74, 3243, 0, 0, 5);
