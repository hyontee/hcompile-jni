...
int OS_FileRead_hook(void* a1, void* a2, int a3)
{
	...
	if (calledFrom == 0x001BDD34 + 1)
	{
		...
		if(a2)dwRLEDecompressSourceSize = *(uint32_t*)a2;
...
int (*CBulletInfo__AddBullet)(CEntity *thiz, int a2, VECTOR a3, VECTOR a4);
int CBulletInfo__AddBullet_hook(CEntity *thiz, int a2, VECTOR a3, VECTOR a4)
{
    CBulletInfo__AddBullet(thiz, a2, a3, a4);
...
void InstallHooks()
{
	...
	SetUpHook(g_libGTASA + 0x00327528, (uintptr_t)CPedDamageResponseCalculator__ComputeDamageResponse_hook, (uintptr_t*)&CPedDamageResponseCalculator__ComputeDamageResponse);
	SetUpHook(g_libGTASA + 0x005669D8, (uintptr_t)CWeapon__GenerateDamageEvent_hook, (uintptr_t*)&CWeapon__GenerateDamageEvent);
	...
	SetUpHook(g_libGTASA + 0x50DEF4, (uintptr_t)CVehicle__ResetAfterRender_hook, (uintptr_t*)& CVehicle__ResetAfterRender);

	SetUpHook(g_libGTASA + 0x3B67F8, (uintptr_t)CRopes__Update_hook, (uintptr_t*)&CRopes__Update);
	SetUpHook(g_libGTASA + 0x3986CC, (uintptr_t)CGame__Process_hook, (uintptr_t*)& CGame__Process);
	SetUpHook(g_libGTASA + 0x4D4A6C, (uintptr_t)CAutomobile__ProcessEntityCollision_hook, (uintptr_t*)& CAutomobile__ProcessEntityCollision);
	...
	SetUpHook(g_libGTASA + 0x0056668C, (uintptr_t)CWeapon__FireSniper_hook, (uintptr_t*)& CWeapon__FireSniper);
	SetUpHook(g_libGTASA + 0x003C70C0, (uintptr_t)CWorld__ProcessLineOfSight_hook, (uintptr_t*)& CWorld__ProcessLineOfSight);
	SetUpHook(g_libGTASA + 0x0055E090, (uintptr_t)CBulletInfo__AddBullet_hook, (uintptr_t*)& CBulletInfo__AddBullet);
