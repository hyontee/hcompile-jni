...
void InitialiseRenderWare_hook()
{
    ...
    //(( void (*)(const char*, int, int))(g_libGTASA+0x1BF244+1))("mta3", 0, 5);
...
void CStreaming_InitImageList_hook()
{
	...
	*(uint32_t*)&ms_files[380] = 0;
    ...
    //(( uint32_t (*)(char*, uint32_t))(g_libGTASA+0x28E7B0+1))("TEXDB\\MTA3.IMG", 1); // CStreaming::AddImageToList
...
{	
	NvUtilInit();
	*(char**)(g_libGTASA + 0x5D1608) = "/storage/emulated/0/DAGMTA/";
}
