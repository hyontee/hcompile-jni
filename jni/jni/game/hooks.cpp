...
void Render2dStuff_hook()
{
	...
	*(uint8_t*)(g_libGTASA+0x7165E8) = 0;
	g_pJavaWrapper->ShowHud(pGame->FindPlayerPed()->GetHealth(), pGame->FindPlayerPed()->GetArmour(), 0, (int)pGame->FindPlayerPed()->GetCurrentWeaponSlot()->dwType, (int)pGame->FindPlayerPed()->GetCurrentWeaponSlot()->dwAmmo, (int)pGame->FindPlayerPed()->GetCurrentWeaponSlot()->dwAmmoInClip, pGame->GetLocalMoney());
}
