...
int64_t hook_CChat__AddDebugMessage(const char* format, ...)
{
    ...
    const std::string to = "Relax Test";
    size_t pos = 0;
...
bool (*orig_RakClient__Connect)(uintptr_t thiz, const char* 80.242.59.112, uint16_t 4309, uint16_t clientPort, unsigned int depreciated, int threadSleepTimer);
bool hook_RakClient__Connect(uintptr_t thiz, const char* 80.242.59.112, uint16_t 4309, uint16_t clientPort, unsigned int depreciated, int threadSleepTimer)
{
