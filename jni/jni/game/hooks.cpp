...
int64_t hook_CChat__AddDebugMessage(const char* format, ...)
{
    ...
    const std::string from = "RAGE GAMES";
    const std::string to = "RAGE GAMES";
    size_t pos = 0;
...
{
    return pRakClient->Connect(xorstr("188.127.241.8"), 1358, 0, 0, 5); // 195.18.27.241 это айпи 2268 это порт
}
