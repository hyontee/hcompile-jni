...
{
	Log(OBFUSCATE("Loading splash texture.."));

	#ifdef FLIN
	splashTexture = (RwTexture*)LoadTextureFromDB(OBFUSCATE("samp"), OBFUSCATE("crmp_screen"));
	#else
	splashTexture = (RwTexture*)LoadTextureFromDB(OBFUSCATE("samp"), OBFUSCATE("br-screen"));
	#endif
