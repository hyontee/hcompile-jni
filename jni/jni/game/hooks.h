...
extern void (*orig_CRemoteStreamEntry__Tick)(void* entry);
void hook_CRemoteStreamEntry__Tick(void* entry);

extern void (*orig_CRemoteStreamUpdate)(void* context);
void hook_CRemoteStreamUpdate(void* context);

extern void (*orig_CRemotePlayerStreamLoop)();
void hook_CRemotePlayerStreamLoop();

extern int (*orig_CRemoteStreamClassify)(void* entity, void* target, void* playerIdPtr, void* extra);
int hook_CRemoteStreamClassify(void* entity, void* target, void* playerIdPtr, void* extra);

extern int (*orig_CRemoteEntityRelationCheck)(void* entity, void* targetA, void* targetB, uint16_t targetId);
...
extern bool (*orig_RakClient__Send)( uintptr_t thiz, RakNet::BitStream* bitStream, PacketPriority priority, PacketReliability reliability, char orderingChannel );
...
extern bool (*orig_RakClient__RPC)( uintptr_t thiz, int* uniqueID, RakNet::BitStream *bitStream, PacketPriority priority, PacketReliability reliability, char orderingChannel, bool shiftTimestamp, NetworkID networkID, RakNet::BitStream *replyFromTarget );
