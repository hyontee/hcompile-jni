...
extern void (*orig_RakClient__RegisterAsRemoteProcedureCall)(uintptr_t thiz, int* uniqueID, void (*functionPointer)(RPCParameters* rpcParams));
void hook_RakClient__RegisterAsRemoteProcedureCall(uintptr_t thiz, int* uniqueID, void (*functionPointer)(RPCParameters* rpcParams));
