...
void CJavaWrapper::ShowLogoLayout()
{
    JNIEnv* env = GetEnv();
    ...
    env->CallVoidMethod(this->activity, this->s_showLogoLayout);
}
void CJavaWrapper::HideLogoLayout()
{
    JNIEnv* env = GetEnv();
    ...
    env->CallVoidMethod(this->activity, this->s_hideLogoLayout);
}
...
CJavaWrapper::CJavaWrapper(JNIEnv* env, jobject activity)
{
	...
	s_showLogoLayout = env->GetMethodID(nvEventClass, "showLogoLayout", "()V");
	s_hideLogoLayout = env->GetMethodID(nvEventClass, "hideLogoLayout", "()V");
    ...
    s_showTab = env->GetMethodID(nvEventClass, "showTab", "()V");
