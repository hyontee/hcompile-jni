...
char CLocalisation::m_szMessages[E_MSG::MSG_COUNT][MAX_LOCALISATION_LENGTH] = {
	"{ffffff}Соединение к {FF0000}BLACK PITER...",
	"{ffffff}Соединено. Подготовка к игре...",
	"{ffffff}Сервер закрыл соеденение, перезайдите",
	"{ffffff}Клиент {ff0000}игры {ffffff}запущен",
	"unused",
