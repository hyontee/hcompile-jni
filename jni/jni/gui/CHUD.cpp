...
// GTASA HOOK
#include "../gui/CHUD/CModelInfo.h"
#include "../gui/CHUD/CHud.h"
...
void CHUD::EditRadar(CRect* rect)
{
    ...
    float mult = 0.9f; //это размер, изменяй его под свой худ (на телефонах он будет ровный везде, главное у себя хотя бы подровняй размер)
