...
extern "C"
{
	JNIEXPORT void JNICALL Java_com_brilliant_cz_GTASA_setClientIp(JNIEnv* pEnv, jobject thiz, jbyteArray ip)
	{
		CClientInfo::SetClientIP(pEnv, thiz, ip);
	}

	JNIEXPORT void JNICALL Java_com_brilliant_cz_GTASA_setClientPort(JNIEnv* pEnv, jobject thiz, jint port)
	{
		CClientInfo::SetClientPort(pEnv, thiz, port);
	}

	JNIEXPORT void JNICALL Java_com_brilliant_cz_GTASA_setClientUuid(JNIEnv* pEnv, jobject thiz, jbyteArray uuid)
	{
		CClientInfo::SetClientUUID(pEnv, thiz, uuid);
	}

	JNIEXPORT void JNICALL Java_com_brilliant_cz_GTASA_setClientLauncherVersion(JNIEnv* pEnv, jobject thiz, jint version)
	{
		CClientInfo::SetClientLauncherVersion(pEnv, thiz, version);
	}
	JNIEXPORT void JNICALL Java_com_brilliant_cz_GTASA_setClientModpackVersion(JNIEnv* pEnv, jobject thiz, jint version)
	{
		CClientInfo::SetClientModPackVersion(pEnv, thiz, version);
	}
	JNIEXPORT void JNICALL Java_com_brilliant_cz_GTASA_setClientMajorVersion(JNIEnv* pEnv, jobject thiz, jint version)
	{
		CClientInfo::SetClientMajorVersion(pEnv, thiz, version);
	}
	JNIEXPORT void JNICALL Java_com_brilliant_cz_GTASA_setClientMinorVersion(JNIEnv* pEnv, jobject thiz, jint version)
	{
		CClientInfo::SetClientMinorVersion(pEnv, thiz, version);
	}
	JNIEXPORT jboolean JNICALL Java_com_brilliant_cz_GTASA_isAPAKAndLibSame(JNIEnv* pEnv, jobject thiz, jint gameEdition)
	{
