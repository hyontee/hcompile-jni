...
{
    //Write(getSym(hGTASA, "numMatrices"), &numMatrices);
    //Write(getSym(hGTASA, "gDummyMatrix"), &gDummyMatrix);
    SET_TO(numMatrices, getSym(hGTASA, "numMatrices"));
    SET_TO(gDummyMatrix, getSym(hGTASA, "gDummyMatrix"));
}
