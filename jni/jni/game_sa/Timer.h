...
#pragma pack(push, 1)
class TimerDefitinition
{
public:
    float GetTime;
    float millisecondRatio;
};
#pragma pack(pop)
...
public:
    ...
    static uint32_t gSuspendDepth;
    static uint8_t gTimerRunning;

    static uint32_t m_snRenderStartTime;
    static uint32_t m_snRenderPauseTime;
    static uint32_t m_snTimerDivider;
    ...
    static uint32_t ms_fTimeStepNonClipped;
...
public:
    ...
    static TimerFunction_t timerDef;
