...
class CJavaWrapper
{
	...
	jmethodID s_showInventorybern;
	jmethodID s_showCararend;
    jmethodID s_showAuction;
...
public:
   ...
   void HideHudAndLogo();
	...
	void ShowInventorybern(int Inventorybern);
	void ShowCararend(int cararend);
    void ShowAuction(int auction);
    ...
    void toggleMicro(bool toggle);

    CVector2DFloat radarBgPos1;
    CVector2DFloat radarBgPos2;
    CVector2DFloat radarPos;
    float bgsize;
    bool bIsHudShow;
};
