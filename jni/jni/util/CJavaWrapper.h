...
class CJavaWrapper
{
	...
	jmethodID s_showReytiz;
	jmethodID s_showLunars;
	jmethodID s_showLunarstop;
	...
	jmethodID s_setTurnState;
	jmethodID s_InitPause;
	jmethodID s_InitMaps;
public:
	JNIEnv* GetEnv();
   ...
   void ShowAuto();
	...
	void ShowReytiz(int money, int bc);
	void ShowLunars(int lunars);
	void ShowLunarstop(int lunarstop);
