...
JNIEXPORT void JNICALL Java_com_nvidia_devtech_NvEventQueueActivity_FamClickSetting(JNIEnv *env, jobject thiz, jint id) 
	...
	JNIEXPORT void JNICALL Java_com_nvidia_devtech_NvEventQueueActivity_sendDeadClick(JNIEnv* pEnv, jobject thiz, jint id)
	{
        switch (id) {
        	case 1: pNetGame->SendChatCommand("/help"); break;
            case 2: pNetGame->SendChatCommand("/dead"); break;
        }
	}
...
void CJavaWrapper::ShowDead() 
{
	...
	Log("Open dead(by reyti x kbass)");
...
void CJavaWrapper::UpdateNameDead(char* name)
{
	...
	env->CallVoidMethod(this->activity, this->s_updatenameDead, jname);

}
void CJavaWrapper::UpdateDead()
{
    JNIEnv* env = GetEnv();
    ...
    env->CallVoidMethod(this->activity, this->s_updateDead);
}
...
CJavaWrapper::CJavaWrapper(JNIEnv* env, jobject activity)
{
	...
	s_updatenameDead = env->GetMethodID(nvEventClass, "updatenameDead", "(Ljava/lang/String;)V");
	s_updateDead = env->GetMethodID(nvEventClass, "updateDead", "()V");
