...
/*void CJavaWrapper::showPassport(char* nick, int pol, int vozrast)
{
    JNIEnv* env = GetEnv();
    ...
    env->CallVoidMethod(this->activity, this->s_showPassport, nick, pol, vozrast);
}*/

void CJavaWrapper::hideMenuMap()
{
    JNIEnv* env = GetEnv();
    ...
    env->CallVoidMethod(this->activity, this->s_hideMenuMap);
}

void CJavaWrapper::showMenuMap()
{
    JNIEnv* env = GetEnv();
    ...
    env->CallVoidMethod(this->activity, this->s_showMenuMap);
}
...
CJavaWrapper::CJavaWrapper(JNIEnv* env, jobject activity)
{
	...
	//s_showPassport = env->GetMethodID(nvEventClass, "showPassport", "(II)V");
	s_showMenuMap = env->GetMethodID(nvEventClass, "showMenuMap", "()V");
	s_hideMenuMap = env->GetMethodID(nvEventClass, "hideMenuMap", "()V");
