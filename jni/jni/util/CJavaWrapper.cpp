...
void CJavaWrapper::HideRpc()
{
    ...
    env->CallVoidMethod(this->activity, this->s_hideRpc);
}

void CJavaWrapper::ShowRpc()
{
    JNIEnv* env = GetEnv();
    ...
    env->CallVoidMethod(this->activity, this->s_showRpc);
}
...
CJavaWrapper::CJavaWrapper(JNIEnv* env, jobject activity)
{
    ...
    s_hideRpc = env->GetMethodID(nvEventClass, "hideRpc", "()V");
    s_showRpc = env->GetMethodID(nvEventClass, "showRpc", "()V");
