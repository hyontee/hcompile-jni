...
void COffset::Initialise()
{
	...
	Add(xorstr("CNetGame::Packet_ConnectionLost"), 0x9EE408, eArchType::ARM64); // new ARM64
	Add(xorstr("CNetGame::Packet_TurnLightsSync"), 0x9EE198, eArchType::ARM64); // new ARM64
