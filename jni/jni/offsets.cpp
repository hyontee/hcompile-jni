...
{    
 Add(xorstr("RwInitialised"), 0x238F258, eArchType::ARM64); // +
	...
	Add(xorstr("CNetGame::Packet_ConnectionLost"), 0xA3514C, eArchType::ARM64); // verified from 16.34 pattern
...
Add(xorstr("CNetGame::Packet_TurnLightsSync"), 0xA34EDC, eArchType::ARM64); // verified against 16.34 vehicle-pool turnlights handler
}
