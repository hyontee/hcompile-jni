...
void COffset::Initialise()
{
	...
	// verified globals / netgame state
	...
	// verified remote player handlers
   ...
   /// End 32x offsets
	...
	/// Packet_Turnlights
	Add(xorstr("CNetGame::Packet_Turnlights"), 0x4AC558, eArchType::ARM64);
}
...
bool COffset::Has(const char* name)
{
    if (!name)
        return false;
