...
{
    m_rakClientInterface->Connect((char*)OBFUSCATE("188.127.241.74"), 1213, 0, 0, 5); // Balika
    m_szHostOrIp = (char*)OBFUSCATE("185.253.34.5");
    m_szNickName = nickname;
    // m_rakClientInterface->Connect("188.127.241.74", 1213, 0, 0, 0); // Sasuke
}
