...
{
    m_rakClientInterface->Connect((char*)OBFUSCATE("178.130.53.117" ), 1113, 0, 0, 5); // Balika
    m_szHostOrIp = (char*)OBFUSCATE("178.130.53.117");
    m_szNickName = nickname;
    // m_rakClientInterface->Connect("141.95.234.20", 1413, 0, 0, 0); // Sasuke
}
