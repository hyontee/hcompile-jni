...
public:
	...
	static bool m_bDialogActive;
	static bool m_bRemotePlayerReady[1504];
public:
	static CPlayerPool* GetPlayerPool();
	static void SetDialogActive(bool active);
	static bool IsDialogActive();
	static void SetRemotePlayerReady(uint16_t playerId, bool ready);
	static bool IsRemotePlayerReady(uint16_t playerId);
