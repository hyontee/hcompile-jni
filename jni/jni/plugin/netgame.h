...
public:
	...
	static void Packet_UnoccupiedSync(Packet* pkt);
	static void Packet_TrailerSync(Packet* pkt);
	static void Packet_SpectatorSync(Packet* pkt);
	static void Packet_MarkersSync(Packet* pkt);
