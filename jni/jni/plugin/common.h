...
enum BRRpcIds : int32_t
{
    ...
    BR_RPC_UpdateScoresPingsIPs = 0xB2,
    ...
    BR_RPC_ClickTextDraw = 0x1B4,
    BR_RPC_ScrSetPlayerSkin = 0x177,
    BR_RPC_ScrRemoveWayPoint = 0x178,
    ...
    BR_RPC_ScrCreateWayPoint = 0x17F,
