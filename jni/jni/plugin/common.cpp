...
void ConvertBRPassengerSyncToSampSync(RakNet::BitStream* bs, BRPassengerSyncData data)
{
    ...
    uint8_t seatFlags = data.byteSeatFlags & 0x7F;
    uint8_t driveBy = data.byteDriveBy & 0x01;
    bs->WriteBits((const unsigned char *)&seatFlags, 7);
    bs->WriteBits((const unsigned char *)&driveBy, 1);
