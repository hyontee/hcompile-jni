...
#endif
#ifdef __aarch64__
  // 64 bit - шром ипе оффсеты для нового билда
  pInterface->RegisterAsRemoteProcedureCall(&RPC_ScrCreateWayPoint, ((void (*)(RPCParameters*))(CGameAPI::m_address + 0x4FA7A4)));
  pInterface->RegisterAsRemoteProcedureCall(&RPC_ScrRemoveWayPoint, ((void (*)(RPCParameters*))(CGameAPI::m_address + 0x4FA904)));
