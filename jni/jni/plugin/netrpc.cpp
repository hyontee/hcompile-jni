...
namespace
{
    ...
    void BR_RPC_Pickup(RPCParameters* rpcParams)
    {
        unsigned int bytes = 0;
        if (GetRpcPayload(rpcParams, bytes))
        {
    ...
    void BR_RPC_DestroyPickup(RPCParameters* rpcParams)
    {
        uint32_t pickupId = 0;
        unsigned int bytes = 0;
        if (GetRpcPayload(rpcParams, bytes))
    ...
    void BR_RPC_SetCheckpoint(RPCParameters* rpcParams)
    {
    ...
    void BR_RPC_DisableCheckpoint(RPCParameters* rpcParams)
    {
...
void RegisterRPCs(RakClientInterface* pInterface)
{
  ...
  RegisterTracked(pInterface, &RPC_SetCheckpoint, ((RpcHandler)(CGameAPI::m_address + 0x335214 + 1)), BR_RPC_SetCheckpoint, g_checkpointHandler);
  ...
  RegisterTracked(pInterface, &RPC_DisableCheckpoint, ((RpcHandler)(CGameAPI::m_address + 0x335338 + 1)), BR_RPC_DisableCheckpoint, g_checkpointRemoveHandler);
  ...
  RegisterTracked(pInterface, &RPC_Pickup, ((RpcHandler)(CGameAPI::m_address + 0x330980 + 1)), BR_RPC_Pickup, g_pickupHandler);
  ...
  RegisterTracked(pInterface, &RPC_DestroyPickup, ((RpcHandler)(CGameAPI::m_address + 0x330A64 + 1)), BR_RPC_DestroyPickup, g_pickupRemoveHandler);
  ...
  RegisterTracked(pInterface, &RPC_SetCheckpoint, ((RpcHandler)(CGameAPI::m_address + 0x500BF0)), BR_RPC_SetCheckpoint, g_checkpointHandler);
  ...
  RegisterTracked(pInterface, &RPC_DisableCheckpoint, ((RpcHandler)(CGameAPI::m_address + 0x500DAC)), BR_RPC_DisableCheckpoint, g_checkpointRemoveHandler);
  ...
  RegisterTracked(pInterface, &RPC_Pickup, ((RpcHandler)(CGameAPI::m_address + 0x4FA3DC)), BR_RPC_Pickup, g_pickupHandler);
  ...
  RegisterTracked(pInterface, &RPC_DestroyPickup, ((RpcHandler)(CGameAPI::m_address + 0x4FA530)), BR_RPC_DestroyPickup, g_pickupRemoveHandler);
