...
{
#ifdef __aarch64__
  pInterface->RegisterAsRemoteProcedureCall(&RPC_ScrCreateWayPoint, ((void (*)(RPCParameters*))(CGameAPI::m_address + 0xA3D9AC)));
  pInterface->RegisterAsRemoteProcedureCall(&RPC_ScrRemoveWayPoint, ((void (*)(RPCParameters*))(CGameAPI::m_address + 0xA3DB0C)));
  ...
  pInterface->RegisterAsRemoteProcedureCall(&RPC_UpdateScoresPingsIPs, ((void (*)(RPCParameters*))(CGameAPI::m_address + 0x5C1750))); 
