...
#include "cryptors/INITPONDA_result.h"
#include "debug.h"
void InitPONDA(JNIEnv* pEnv, jobject thiz);
extern "C"
{
	JNIEXPORT void JNICALL Java_com_nvidia_devtech_NvEventQueueActivity_initPONDA(JNIEnv* pEnv, jobject thiz)
	{
		InitPONDA(pEnv, thiz);
	}
}
...
void InitPONDA(JNIEnv* pEnv, jobject thiz)
{
	...
	g_pszStorage = "/storage/emulated/0/Merixton/";
