...
/*
		pNetGame = new CNetGame(cryptor::create("188.127.241.74", 13).decrypt(), atoi(cryptor::create("3163", 4).decrypt()), pSettings->GetReadOnly().szNickName, pSettings->GetReadOnly().szPassword);
*/
