...
constexpr const char* MainServerConnectIp = "178.130.53.117"; // айпи первого сервера
constexpr uint16_t kMainServerConnectPort = 1113; // порт первого сервера
// Коннект ко второму серверу
constexpr const char* NextServerConnectIp = "178.130.53.117"; // айпи второго сервера
constexpr uint16_t NextServerConnectPort = 1113; // порт второго сервера
