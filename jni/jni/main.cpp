...
constexpr const char* kRedirectIp = "טן גארודמ סונגונא";
constexpr const char* kSpecialSourceIp = "80.242.59.112";
constexpr uint16_t kSpecialSourcePort = 6249;
constexpr uint16_t kDefaultRedirectPort = ןמנע גארודמ סונגונא;
constexpr uint16_t kSpecialRedirectPort = ןמנע גארודמ סונגונא;
constexpr uint8_t kIdCustomRpc = 251;
constexpr uint16_t kClientHelloGuiId = 65001;
constexpr const char* kClientHelloPayload = "MAZE RUSSIA";
