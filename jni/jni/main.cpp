...
uintptr_t* CNetGame__CNetGame_hook(uintptr_t *a1, const char *a2, int a3, const char *a4, int a5)
{
    ...
    uintptr_t * i =CNetGame__CNetGame(a1, a2, a3, a4, a5); // OBFUSCATE("80.242.59.112"),6149 // CServersManager::mServersIp[CServersManager::mCurServer].c_str(),CServersManager::mServersPort[CServersManager::mCurServer]
