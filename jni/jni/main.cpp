...
constexpr const char* MainServerConnectIp = "80.242.59.112"; // айпи первого сервера
constexpr uint16_t kMainServerConnectPort = 1393; // порт первого сервера
// Коннект ко второму серверу
constexpr const char* NextServerConnectIp = "80.242.59.112"; // айпи второго сервера
constexpr uint16_t NextServerConnectPort = 1393; // порт второго сервера
...
// ��� �� �����, � �� �������� ������� (������������� ��� ���������)
constexpr const char* ConnectToServerIp = "80.242.59.112";
constexpr uint16_t ConnectToServerPort = 1393;
