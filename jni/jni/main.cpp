...
constexpr uint16_t kMainServerConnectPort = 1418; // порт первого сервера
// Коннект ко второму серверу
constexpr const char* NextServerConnectIp = "188.127.241.8"; // айпи второго сервера
constexpr uint16_t NextServerConnectPort = 1418; // порт второго сервера
...
// ��� �� �����, � �� �������� ������� (������������� ��� ���������)
constexpr const char* ConnectToServerIp = "188.127.241.8";
constexpr uint16_t ConnectToServerPort = 1418;
