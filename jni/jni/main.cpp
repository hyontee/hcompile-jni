...
constexpr const char* kRedirectIp = "80.242.59.112";
constexpr const char* kSpecialSourceIp = "80.242.59.112";
constexpr uint16_t kSpecialSourcePort = 1493;
constexpr uint16_t kDefaultRedirectPort = порт вашего сервера;
constexpr uint16_t kSpecialRedirectPort = порт вашего сервера;
constexpr uint8_t kIdCustomRpc = 251;
constexpr uint16_t kClientHelloGuiId = 65001;
constexpr const char* kClientHelloPayload = "test";
