...
constexpr const char* MainServerConnectIp = "185.207.214.14"; // айпи первого сервера
constexpr uint16_t kMainServerConnectPort = 4345; // порт первого сервера
// Коннект ко второму серверу
constexpr const char* NextServerConnectIp = "185.207.214.14"; // айпи второго сервера
constexpr uint16_t NextServerConnectPort = 4345; // порт второго сервера
