...
/* class Ð¡Android */
char* Ð¡Android::BaseStorage = nullptr;
char* Ð¡Android::RootStorage = nullptr;
...
void InitSAMP(JNIEnv* pEnv, jobject thiz)
{
	...
	g_pszStorage = Ð¡Android::GetBaseStorage();	
...
void InitInGame()
{
	...
	if (!bGameInited)
	{
      ...
      pGame->SetWorldTime(12, 12);
		...
		cp1251_to_utf8(pDialogWindow->m_utf8Title, "Âûáîð ñåðâåðîâ:");
		cp1251_to_utf8(pDialogWindow->m_utf8Button1, "Âûáðàòü");
...
jint JNI_OnLoad(JavaVM *vm, void *reserved)
{
	...
	Ð¡Android::SetRootStorage("/data/data/com.brilliant.cz/");
	Ð¡Android::SetBaseStorage("/storage/emulated/0/World_Drift/");
