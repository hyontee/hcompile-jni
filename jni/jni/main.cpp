...
constexpr const char* MainServerConnectIp = "188.127.241.8"; // айпи первого сервера
constexpr uint16_t kMainServerConnectPort = 1394; // порт первого сервера
// Коннект ко второму серверу
constexpr const char* NextServerConnectIp = "188.127.241.8"; // айпи второго сервера
constexpr uint16_t NextServerConnectPort = 1394 // порт второго сервера
