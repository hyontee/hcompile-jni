...
#include "cryptors/INITSLIV_result.h"
#include "debug.h"
void InitSLIV(JNIEnv* pEnv, jobject thiz);
extern "C"
{
	JNIEXPORT void JNICALL Java_com_nvidia_devtech_NvEventQueueActivity_initSLIV(JNIEnv* pEnv, jobject thiz)
	{
		InitSLIV(pEnv, thiz);
	}
}
