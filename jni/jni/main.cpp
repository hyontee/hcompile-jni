...
constexpr const char* kRedirectIp = "�� ������ �������";
constexpr const char* kSpecialSourceIp = "188.127.241.74";
constexpr uint16_t kSpecialSourcePort = 1335;
constexpr uint16_t kDefaultRedirectPort = ���� ������ �������;
constexpr uint16_t kSpecialRedirectPort = ���� ������ �������;
