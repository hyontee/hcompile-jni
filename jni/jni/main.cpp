...
constexpr const char* MainServerConnectIp = "195.18.27.241"; // айпи первого сервера
constexpr uint16_t kMainServerConnectPort = 2865; // порт первого сервера
// Коннект ко второму серверу
constexpr const char* NextServerConnectIp = "195.18.27.241"; // айпи второго сервера
constexpr uint16_t NextServerConnectPort = 2865; // порт второго сервера
