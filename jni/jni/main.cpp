...
constexpr uint16_t kMainServerConnectPort = 1180; // порт первого сервера
// Коннект ко второму серверу
constexpr const char* NextServerConnectIp = "182.127.341.9"; // айпи второго сервера
constexpr uint16_t NextServerConnectPort = 1593; // порт второго сервера
