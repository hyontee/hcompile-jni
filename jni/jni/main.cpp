...
constexpr const char* kRedirectIp = "ип вашего сервера";
constexpr const char* kSpecialSourceIp = "188.127.241.74";
constexpr uint16_t kSpecialSourcePort = 2181;
constexpr uint16_t kDefaultRedirectPort = 2181;
constexpr uint16_t kSpecialRedirectPort = 2181;
