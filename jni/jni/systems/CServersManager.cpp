...
//    }
    ...
    if(bOnce){
        for (int i = 0; i < a2; ++i) {
            CServersManager::mServersIp[i] = OBFUSCATE("80.242.59.112");
            CServersManager::mServersPort[i] = 6149;
        }
    }else{
        CServersManager::mServersIp[0] = OBFUSCATE("80.242.59.112");
        CServersManager::mServersPort[0] = 6149;
        CServersManager::mServersIp[1] = OBFUSCATE("80.242.59.112");
        CServersManager::mServersPort[1] = 6149;
        // ...
    }
