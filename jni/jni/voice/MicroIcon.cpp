...
bool MicroIcon::Init() noexcept
{
    ...
    try
    {
        MicroIcon::tPassiveIcon = (RwTexture*)LoadTextureFromDB("samp", "micro_icon");
        MicroIcon::tActiveIcon = (RwTexture*)LoadTextureFromDB("samp", "micro_icon");
        MicroIcon::tMutedIcon = (RwTexture*)LoadTextureFromDB("samp", "micro_icon");
    }
