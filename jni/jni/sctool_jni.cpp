...
std::string png2sc       (const std::string&, const std::string&, int, const std::string&);
...
std::string inject_put   (const std::string&, const std::string&, const std::string&);
std::string inject_list  (const std::string&);
std::string anim2static  (const std::string&, const std::string&);
std::string build_sc     (const std::string&, const std::string&);
std::string mc_copy      (const std::string&, const std::string&, const std::string&);
...
JNIEXPORT jstring JNICALL FN(_nativeDowngrade)(JNIEnv* e, jclass, jstring a, jstring b)
    { return toj(e, sc_downgrade(jstr(e,a), jstr(e,b))); }

JNIEXPORT jstring JNICALL FN(_nativeKtx2Png)(JNIEnv* e, jclass, jstring a, jstring b)
    { return toj(e, ktx2png(jstr(e,a), jstr(e,b))); }

JNIEXPORT jstring JNICALL FN(_nativePng2Ktx)(JNIEnv* e, jclass, jstring a, jstring b)
    { return toj(e, png2ktx(jstr(e,a), jstr(e,b))); }

JNIEXPORT jstring JNICALL FN(_nativePng2Sc)(JNIEnv* e, jclass, jstring png, jstring orig, jint idx, jstring out)
    { return toj(e, png2sc(jstr(e,png), jstr(e,orig), (int)idx, jstr(e,out))); }
...
JNIEXPORT jstring JNICALL FN(_nativeInjectPut)(JNIEnv* e, jclass, jstring a, jstring b, jstring c)
    { return toj(e, inject_put(jstr(e,a), jstr(e,b), jstr(e,c))); }
...
JNIEXPORT jstring JNICALL FN(_nativeBuildSc)(JNIEnv* e, jclass, jstring a, jstring b)
    { return toj(e, build_sc(jstr(e,a), jstr(e,b))); }

JNIEXPORT jstring JNICALL FN(_nativeMcCopy)(JNIEnv* e, jclass, jstring a, jstring b, jstring c)
    { return toj(e, mc_copy(jstr(e,a), jstr(e,b), jstr(e,c))); }
