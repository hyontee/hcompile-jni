...
public:
	...
	void SendReconIpacket(int id);
	void SendStylingIpacket(int id);
	void SendIpacketColorPickerRgb(int red, int green, int blue);
	void SendStylingIpacketNotPay(int cost);
	void SendIpacketGiveLiveCoins(int coins);
	void SendQueryBuyEventItem(int cost);
