...
/*
        ...
        КРАНИН НЕ ЧЕГО НЕ СДЕЛАЛ!!!! - МАТРЕШКА РП БУ ЭДГАР 3.0 :)
...
//#define RPC_SHOW_PASSPORT	0x16
//#define RPC_SHOW_SPAWN 0x17
...
void CNetGame::Packet_CustomRPC(Packet* p)
{
	...
	/*case RPC_SHOW_PASSPORT:
	{
		...
		bs.Read(szBuff, lenNick);
		cp1251_to_utf8(nick, szBuff);

		g_pJavaWrapper->showPassport(nick, pol, vozrast);
		return;
	}*/
