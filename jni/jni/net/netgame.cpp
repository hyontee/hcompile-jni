...
{
	strcpy(m_szHostName, "SPACE RP by EDGAR 3.0");
...
void CNetGame::Process()
{
	...
	else
	{
        ...
        if(!pon && pPlayer && pCamera)
        {
            pGame->DisplayGameText("By EDGAR 3.0", 3, 0);
            ...
            case 0: // скай
            {*/
            //pGame->NewVehicle(415, 433.8335, 250.1207, 11.9394, 0, false);
            /*    break;
                  }
                                  }    */
        //}
