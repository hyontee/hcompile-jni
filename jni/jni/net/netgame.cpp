...
void CNetGame::Process()
{
    ...
    else
    {
        ...
        if(pPlayer && pCamera)
        {
            ...
            pCamera->SetPosition(-682.3105f, -809.6567f, 85.04970f, 0.0f, 0.0f, 0.0f);
			pCamera->LookAtPoint(-682.8230f, -959.9548f, 87.0f, 2);
...
void CNetGame::Packet_CustomRPC(Packet* p)
{
    ...
    switch (rpcID)
    {
        case RPC_CHECK:
        {
            ...
            // if(num != 180)
            // {
            //     Log(obfuscate(">> use actual version"));
            //     std::terminate();
            // }
