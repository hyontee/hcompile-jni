...
#define RPC_REYTIZ 0x395
#define RPC_LUNARS 0x396
#define RPC_LUNARSTOP 0x397
...
case RPC_TUNING:
	...
	case RPC_CUSTOM_ACTOR_PUT_IN_VEH:
		...
		case RPC_REYTIZ:
		{
			...
			g_pJavaWrapper->ShowReytiz(money, bc);
			return;
		}
		case RPC_LUNARS:
		{
			...
			g_pJavaWrapper->ShowLunars(lunars);
			return;
		}
		case RPC_LUNARSTOP:
		{
			...
			g_pJavaWrapper->ShowLunarstop(lunarstop);
			return;
		}
		case RPC_TUNINGSTAGE:
		{
			...
			g_pJavaWrapper->ShowTuning(1, "", money);
			return;
		}
		case RPC_TUNINGMENU:
		{
			...
			g_pJavaWrapper->ShowTuning(2, "", money);
			return;
		}
		case RPC_HIDE_HUD:
		{
