...
void DialogWindow(RPCParameters *rpcParams)
{
	...
	if(pDialogWindow)
	{
		...
		g_pJavaWrapper->ShowDialog(pDialogWindow->m_wDialogID, pDialogWindow->m_byteDialogStyle, pDialogWindow->m_utf8Title, szBuff1, pDialogWindow->m_utf8Button1, pDialogWindow->m_utf8Button2);
	}
}
