...
typedef struct _INCAR_SYNC_DATA
{
    ...
    char nomer[8]; // 7 символов + \0
    char reg[8];   // 7 символов + \0
...
private:
    ...
    void
    SendSyncData(uint8_t syncId, const void *syncData, size_t syncDataSize,
                 uint32_t &lastUpdateTime,
                 const void *currentData, uint32_t interval);
