...
void CSettings::Save(int iIgnoreCategory)
{
	...
	if (iIgnoreCategory != 2)
	{
		...
		ini_table_create_entry_as_float(config, OBFUSCATE("gui"), OBFUSCATE("PassengerCycleSize"), m_Settings.fButtonPassengerCycleSize);
		ini_table_create_entry_as_float(config, OBFUSCATE("gui"), OBFUSCATE("PassengerCycleX"), m_Settings.fButtonPassengerCycleX);
		ini_table_create_entry_as_float(config, OBFUSCATE("gui"), OBFUSCATE("PassengerCycleY"), m_Settings.fButtonPassengerCycleY);
	}
	...
	if (iIgnoreCategory != 1)
	{
		...
		ini_table_create_entry_as_int(config, OBFUSCATE("gui"), OBFUSCATE("graphics"), m_Settings.iGraphics);
	}
...
void CSettings::LoadSettings(const char* szNickName, int iChatLines)
{
	...
	m_Settings.iGraphics = ini_table_get_entry_as_int(config, OBFUSCATE("gui"), OBFUSCATE("graphics"), 0);
	...
	m_Settings.iCrossHair = ini_table_get_entry_as_int(config, OBFUSCATE("gui"), OBFUSCATE("crossHair"), 1);
	m_Settings.iNewHud = ini_table_get_entry_as_int(config, "gui", "newhud", 1);
    m_Settings.iCacheTextDraw = ini_table_get_entry_as_int(config, OBFUSCATE("gui"), OBFUSCATE("cacheTextDraw"), 1);
