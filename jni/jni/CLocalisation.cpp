...
char CLocalisation::m_szMessages[E_MSG::MSG_COUNT][MAX_LOCALISATION_LENGTH] = {
	"Подключение к серверу BLACK PITER...",
	"Авторизация в игре...",
	"Соединение с сервером было разорвано. Пожалуйста попробуйте войти заново.",
	"Обнаружены изменения в некоторых файлах. Рекомендуется переустановить клиент.",
	"Неиспользуемая команда.",
	"Ваш доступ к серверу был заблокирован.",
	"Соединение с сервером потеряно. Попытка переподключения...",
	"Возникли проблемы с сетью. Попытка повторного подключения...",
	"Сервер заполнен. Пожалуйста, попробуйте позже."
};
